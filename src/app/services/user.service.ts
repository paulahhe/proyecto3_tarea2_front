...
export class UserService extends BaseService<IUser> { //Hereda los metodos de BaseService
  protected override source: string = 'users';
  private userListSignal = signal<IUser[]>([]); //
  get users$() {
    return this.userListSignal; //variable que retorna el valor de la señal cada vez que cambie
