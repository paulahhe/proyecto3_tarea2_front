...
export class OrdersService extends BaseService<IOrder> {
  protected override source: string = 'orders'; //Viene de mi clase orders del backend
  private orderListSignal = signal<IOrder[]>([]); //Lista vacias para que nuestro codigo de componente reacciona a los cambios
  get orders$() { //Obtener el valor de signal cada vez que cambia
